...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DListNode inserting = ((DList) myList).newNode(item, (DList) myList, this, this.next);
    this.next.prev = inserting;
    this.next = inserting;
    myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    DListNode inserting = ((DList) myList).newNode(item, (DList) myList, this.prev, this);
    this.prev.next = inserting;
    this.prev = inserting;
    myList.size++;
  }
